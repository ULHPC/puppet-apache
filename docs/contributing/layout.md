...
│   ├── ...             # Implementation of the other apache::* classes / definitions
...
├── pkg/                # Hold build packages to be published on the [Puppet forge](https://forge.puppetlabs.com/ULHPC/apache)
