...
By default, the [puppet-apache](https://github.com/ULHPC/puppet-apache) repository is bound to the [ulhpc-puppet-apache](http://ulhpc-puppet-apache.rtfd.org) project on Read the Docs (to avoid confusion with other apache projects). 
